...
import { User, Mail, Lock, FileSpreadsheet, Percent, Clipboard, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-2xl w-full space-y-8 bg-white border border-slate-200/80 p-10 sm:p-12 rounded-3xl shadow-xl shadow-slate-200/50 relative z-10 animate-slide-up">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Roll Number */}
            <div>
              <label htmlFor="rollNumber" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">
                Roll Number / ID
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
            ...
            {/* Branch */}
            <div>
              <label htmlFor="branch" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">
                Academic Branch
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                ...
                >
                  {branches.map((b) => (
                    <option key={b.code} value={b.code} className="text-slate-800">
                      {b.code} - {b.name}
                    </option>
                  ))}
                </select>
            ...
            {/* Year of Study */}
            <div>
              <label htmlFor="year" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">
                Current Year
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
            ...
            <div className="md:col-span-2">
              <label htmlFor="cgpa" className="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">
