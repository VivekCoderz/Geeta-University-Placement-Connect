      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="flex items-center justify-between h-20"> {/* Increased navbar height for breathing room */}
          ...
          <div className="flex items-center">
            <Link to={user?.role === 'company' ? '/recruiter/dashboard' : user?.role === 'placementCell' ? '/placement/dashboard' : '/'} className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-slate-400 font-mono mt-0.5">{user.role === 'company' ? 'Recruiter' : user.role === 'placementCell' ? 'T&P Cell' : user.rollNumber}</span>
                  </div>
                </div>
                <button
